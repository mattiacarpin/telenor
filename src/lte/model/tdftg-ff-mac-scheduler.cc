...
NS_LOG_COMPONENT_DEFINE("TdFtgFfMacScheduler");

namespace ns3 {

int TdFtgType0AllocationRbg[4] = { 10,       // RGB size 1
		26,       // RGB size 2
		63,       // RGB size 3
		110       // RGB size 4
};// see table 7.1.6.1-1 of 36.213

NS_OBJECT_ENSURE_REGISTERED (TdFtgFfMacScheduler);

class TdFtgSchedulerMemberCschedSapProvider: public FfMacCschedSapProvider {
public:
	TdFtgSchedulerMemberCschedSapProvider(TdFtgFfMacScheduler* scheduler);
...
private:
	TdFtgSchedulerMemberCschedSapProvider();
	TdFtgFfMacScheduler* m_scheduler;
};

TdFtgSchedulerMemberCschedSapProvider::TdFtgSchedulerMemberCschedSapProvider() {
}

TdFtgSchedulerMemberCschedSapProvider::TdFtgSchedulerMemberCschedSapProvider(
		TdFtgFfMacScheduler* scheduler) :
						m_scheduler(scheduler) {
}

void TdFtgSchedulerMemberCschedSapProvider::CschedCellConfigReq(
		const struct CschedCellConfigReqParameters& params) {
	m_scheduler->DoCschedCellConfigReq(params);
}

void TdFtgSchedulerMemberCschedSapProvider::CschedUeConfigReq(
		const struct CschedUeConfigReqParameters& params) {
	m_scheduler->DoCschedUeConfigReq(params);
}

void TdFtgSchedulerMemberCschedSapProvider::CschedLcConfigReq(
		const struct CschedLcConfigReqParameters& params) {
	m_scheduler->DoCschedLcConfigReq(params);
}

void TdFtgSchedulerMemberCschedSapProvider::CschedLcReleaseReq(
		const struct CschedLcReleaseReqParameters& params) {
	m_scheduler->DoCschedLcReleaseReq(params);
}

void TdFtgSchedulerMemberCschedSapProvider::CschedUeReleaseReq(
		const struct CschedUeReleaseReqParameters& params) {
	m_scheduler->DoCschedUeReleaseReq(params);
}

class TdFtgSchedulerMemberSchedSapProvider: public FfMacSchedSapProvider {
public:
	TdFtgSchedulerMemberSchedSapProvider(TdFtgFfMacScheduler* scheduler);
...
private:
	TdFtgSchedulerMemberSchedSapProvider();
	TdFtgFfMacScheduler* m_scheduler;
};

TdFtgSchedulerMemberSchedSapProvider::TdFtgSchedulerMemberSchedSapProvider() {
}
...
void TdFtgSchedulerMemberSchedSapProvider::SchedDlRlcBufferReq(
		const struct SchedDlRlcBufferReqParameters& params) {
	m_scheduler->DoSchedDlRlcBufferReq(params);
}

void TdFtgSchedulerMemberSchedSapProvider::SchedDlPagingBufferReq(
		const struct SchedDlPagingBufferReqParameters& params) {
	m_scheduler->DoSchedDlPagingBufferReq(params);
}

void TdFtgSchedulerMemberSchedSapProvider::SchedDlMacBufferReq(
		const struct SchedDlMacBufferReqParameters& params) {
	m_scheduler->DoSchedDlMacBufferReq(params);
}

void TdFtgSchedulerMemberSchedSapProvider::SchedDlTriggerReq(
		const struct SchedDlTriggerReqParameters& params) {
	m_scheduler->DoSchedDlTriggerReq(params);
}

void TdFtgSchedulerMemberSchedSapProvider::SchedDlRachInfoReq(
		const struct SchedDlRachInfoReqParameters& params) {
	m_scheduler->DoSchedDlRachInfoReq(params);
}

void TdFtgSchedulerMemberSchedSapProvider::SchedDlCqiInfoReq(
		const struct SchedDlCqiInfoReqParameters& params) {
	m_scheduler->DoSchedDlCqiInfoReq(params);
}

void TdFtgSchedulerMemberSchedSapProvider::SchedUlTriggerReq(
		const struct SchedUlTriggerReqParameters& params) {
	m_scheduler->DoSchedUlTriggerReq(params);
}

void TdFtgSchedulerMemberSchedSapProvider::SchedUlNoiseInterferenceReq(
		const struct SchedUlNoiseInterferenceReqParameters& params) {
	m_scheduler->DoSchedUlNoiseInterferenceReq(params);
}

void TdFtgSchedulerMemberSchedSapProvider::SchedUlSrInfoReq(
		const struct SchedUlSrInfoReqParameters& params) {
	m_scheduler->DoSchedUlSrInfoReq(params);
}

void TdFtgSchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq(
		const struct SchedUlMacCtrlInfoReqParameters& params) {
	m_scheduler->DoSchedUlMacCtrlInfoReq(params);
}

void TdFtgSchedulerMemberSchedSapProvider::SchedUlCqiInfoReq(
		const struct SchedUlCqiInfoReqParameters& params) {
	m_scheduler->DoSchedUlCqiInfoReq(params);
}

TdFtgFfMacScheduler::TdFtgFfMacScheduler() :
					m_cschedSapUser(0), m_schedSapUser(0), m_nextRntiUl(0) {
	m_amc = CreateObject<LteAmc>();
	m_cschedSapProvider = new TdFtgSchedulerMemberCschedSapProvider(this);
	m_schedSapProvider = new TdFtgSchedulerMemberSchedSapProvider(this);
...
void TdFtgFfMacScheduler::DoDispose() {
	NS_LOG_FUNCTION (this);
...
TypeId TdFtgFfMacScheduler::GetTypeId(void) {
	static TypeId tid = TypeId("ns3::TdFtgFfMacScheduler").SetParent<
			FfMacScheduler>().AddConstructor<TdFtgFfMacScheduler>().AddAttribute(
					"CqiTimerThreshold",
					"The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
					UintegerValue(1000),
					MakeUintegerAccessor(&TdFtgFfMacScheduler::m_cqiTimersThreshold),
					MakeUintegerChecker<uint32_t>()).AddAttribute("HarqEnabled",
							"Activate/Deactivate the HARQ [by default is active].",
							BooleanValue(true),
							MakeBooleanAccessor(&TdFtgFfMacScheduler::m_harqOn),
							MakeBooleanChecker()).AddAttribute("UlGrantMcs",
									"The MCS of the UL grant, must be [0..15] (default 0)",
									UintegerValue(0),
									MakeUintegerAccessor(&TdFtgFfMacScheduler::m_ulGrantMcs),
									MakeUintegerChecker<uint8_t>());
	return tid;
}

void TdFtgFfMacScheduler::SetFfMacCschedSapUser(FfMacCschedSapUser* s) {
	m_cschedSapUser = s;
}

void TdFtgFfMacScheduler::SetFfMacSchedSapUser(FfMacSchedSapUser* s) {
	m_schedSapUser = s;
}

FfMacCschedSapProvider*
TdFtgFfMacScheduler::GetFfMacCschedSapProvider() {
	return m_cschedSapProvider;
}

FfMacSchedSapProvider*
TdFtgFfMacScheduler::GetFfMacSchedSapProvider() {
	return m_schedSapProvider;
}

void TdFtgFfMacScheduler::DoCschedCellConfigReq(
...
void TdFtgFfMacScheduler::DoCschedUeConfigReq(
...
void TdFtgFfMacScheduler::DoCschedLcConfigReq(
...
void TdFtgFfMacScheduler::DoCschedLcReleaseReq(
...
void TdFtgFfMacScheduler::DoCschedUeReleaseReq(
...
void TdFtgFfMacScheduler::DoSchedDlRlcBufferReq(
...
void TdFtgFfMacScheduler::DoSchedDlPagingBufferReq(
...
void TdFtgFfMacScheduler::DoSchedDlMacBufferReq(
...
int TdFtgFfMacScheduler::GetRbgSize(int dlbandwidth) {
	for (int i = 0; i < 4; i++) {
		if (dlbandwidth < TdFtgType0AllocationRbg[i]) {
			return (i + 1);
		}
	}
...
int TdFtgFfMacScheduler::LcActivePerFlow(uint16_t rnti) {
	std::map<LteFlowId_t, FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
	int lcActive = 0;
...
int TdFtgFfMacScheduler::getQueueSize(uint16_t rnti)
{
	std::map<LteFlowId_t, FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
	int queueSize=0;
	for (it = m_rlcBufferReq.begin(); it != m_rlcBufferReq.end(); it++)
...
uint8_t TdFtgFfMacScheduler::HarqProcessAvailability(uint16_t rnti) {
...
uint8_t TdFtgFfMacScheduler::UpdateHarqProcessId(uint16_t rnti) {
	NS_LOG_FUNCTION (this << rnti);
...
void TdFtgFfMacScheduler::RefreshHarqProcesses() {
	NS_LOG_FUNCTION (this);
...
void TdFtgFfMacScheduler::DoSchedDlTriggerReq(
...
void TdFtgFfMacScheduler::DoSchedDlRachInfoReq(
...
void TdFtgFfMacScheduler::DoSchedDlCqiInfoReq(
...
double TdFtgFfMacScheduler::EstimateUlSinr(uint16_t rnti, uint16_t rb)
{
...
double TdFtgFfMacScheduler::EstimateDlSinr(uint16_t rnti, uint16_t rb)
{
	std::map<uint16_t, std::vector<double> >::iterator itCqi = m_ueCqi.find(rnti);
	if (itCqi == m_ueCqi.end())
	{
...
void TdFtgFfMacScheduler::DoSchedUlTriggerReq(
...
void TdFtgFfMacScheduler::DoSchedUlCqiInfoReq(
	...
	case UlCqi_s::PRACH: {
		NS_FATAL_ERROR(
				"TdFtgFfMacScheduler supports only PUSCH and SRS UL-CQIs");
	}
	break;
	default:
...
void TdFtgFfMacScheduler::RefreshDlCqiMaps(void) {
...
void TdFtgFfMacScheduler::RefreshUlCqiMaps(void) {
	// refresh UL CQI  Map
...
void TdFtgFfMacScheduler::UpdateDlRlcBufferInfo(uint16_t rnti, uint8_t lcid,
		uint16_t size) {
	std::map<LteFlowId_t, FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
...
void TdFtgFfMacScheduler::UpdateUlRlcBufferInfo(uint16_t rnti, uint16_t size) {
...
void TdFtgFfMacScheduler::TransmissionModeConfigurationUpdate(uint16_t rnti,
		uint8_t txMode) {
...
int TdFtgFfMacScheduler::getIMSI(int RNTI)
{
...
double TdFtgFfMacScheduler::getAlphaFromRNTI(int RNTI)
{
