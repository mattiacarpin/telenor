...
#ifndef TDFTG_FF_MAC_SCHEDULER_H
#define TDFTG_FF_MAC_SCHEDULER_H
...
class TdFtgFfMacScheduler : public FfMacScheduler
{
public:
  /**
   * \brief Constructor
  ...
  friend class TdFtgSchedulerMemberCschedSapProvider;
  friend class TdFtgSchedulerMemberSchedSapProvider;
...
#endif /* TDFTG_FF_MAC_SCHEDULER_H */
